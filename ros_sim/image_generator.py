...
def make_image(distance, count, x_offset, color = (0,0,255)):
	...
	angle = 0
	radious = np.interp(distance, [0,80],[float(CIRCLE_RADIOUS),float(MIN_CIRCLE_RADIOUS)])
	...
	cv2.imwrite("/home/ubuntu/catkin_ws/src/race/src/camera_feed/"+"im"+ pad_digits*"0"+ str(count) +".png",img)
